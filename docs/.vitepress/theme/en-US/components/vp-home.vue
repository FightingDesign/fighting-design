  ...
  <div class="vp-home">
    ...
    <div class="vp-home__content">
      ...
      <div class="vp-home__describe">
        ...
        <!-- 副标题 -->
        <h1 class="vp-home__subtitle">
          You can quickly build an interactive interface in the vue3 application, which looks good.
        </h1>

        <!-- 介绍 -->
        <p class="vp-home__introduce">
          <strong>🌈 Fighting Design</strong>
          is a flexible and high-quality component library for developers. It is hoped that developers can borrow the
          design from it and breed higher level component libraries in the near future.
        </p>

        <!-- 开始按钮 -->
        <f-button type="primary" size="large" href="/docs/install">Getting started</f-button>
      </div>
      ...
      <div class="vp-home__contributors">
        ...
        <f-button simple type="primary" href="/docs/contributing.html" round>Join</f-button>
      </div>
