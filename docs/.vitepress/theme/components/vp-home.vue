...
const fontColor = computed(()=>isDark.value ? 'var(--vp-c-text-dark-1)' : 'var(--vp-c-text-light-1)')
  ...
  <div class="vp-home">
    ...
    <div class="vp-home__banner">
      <div class="vp-home__logo-box">
        <f-avatar class="vp-home__logo" src="https://tianyuhao.cn/images/fighting-design/FightingDesign.svg"
          alt="Fighting Design logo" :draggable="false" :size="500" />
      </div>
    </div>
    ...
    <div class="vp-home__content">
      ...
      <div class="vp-home__describe">
        <!-- logo -->
        <f-avatar ref="fightingLogo" class="vp-home__logo fighting__logo" draggable="false"
          src="https://tianyuhao.cn/images/fighting-design/FightingDesign.svg" alt="Fighting Design logo" :size="120" />
        ...
        <h1 class="vp-home__title">
          ...
          <f-link href="https://github.com/FightingDesign/fighting-design" target="_blank">
            <f-image src="https://img.shields.io/github/stars/FightingDesign/fighting-design?style=social"
              alt="Fighting Design" />
          </f-link>
        </h1>
      ...
      <div class="vp-home__contributors">
        <f-text block center bold size="26px" :color="fontColor">{{ homeContent.contributors }}</f-text>
        ...
        <div class="vp-home__footer-content">
          <ul class="vp-home__footer-list" v-for="(listItem, index) in footerContent" :key="index">
            ...
            <li class="vp-home__footer-item" v-for="(list, i) in listItem.item" :key="i">
              <f-link :color="fontColor" target="_blank"
                :href="list.link">
                {{ list.text }}
              </f-link>
            </li>
