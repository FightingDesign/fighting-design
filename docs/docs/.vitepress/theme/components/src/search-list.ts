export const searchList = [
  ...
  { title: 'Svg Icon 图标', rule: 'svg-iconSvgIcon图标', url: 'components/svg-icon', },
  ...
  { title: 'Image Preview 图片预览', rule: 'image-previewImagePreview图片预览', url: 'components/image-preview' },
  ...
  { title: 'Progress 进度条', rule: 'progressProgress进度条', url: 'components/progress' },
  ...
  { title: 'Checkbox 复选框', rule: 'checkboxCheckbox复选框', url: 'components/checkbox' },
  { title: 'ExpandCard 折叠动效', rule: 'expand-cardExpandCard折叠动效', url: 'components/expand-card' },
  { title: 'Tree 树', rule: 'treeTree树', url: 'components/tree' },
  { title: 'StickyCard 粘性卡片', rule: 'sticky-cardStickyCard粘性卡片', url: 'components/sticky-card' },
  { title: 'Rate 评分', rule: 'rateRate评分', url: 'components/rate' },
  { title: 'Input 输入框', rule: 'inputInput输入框', url: 'components/input' },
  { title: 'Up Load 文件上传', rule: 'up-loadUpLoad文件上传', url: 'components/up-load' },
  { title: 'Table 表格', rule: 'tableTable表格', url: 'components/table' },
  { title: 'Breadcrumb 面包屑', rule: 'breadcrumbBreadcrumb面包屑', url: 'components/breadcrumb' },
  { title: 'Page Header 页头', rule: 'page-headerPageHeader页头', url: 'components/page-header' },
  { title: 'Close Btn 关闭按钮', rule: 'close-btnCloseBtn关闭按钮', url: 'components/close-btn' },
  { title: 'Dropdown 下拉菜单', rule: 'dropdownDropdown下拉菜单', url: 'components/dropdown' },
  { title: 'Alert 警告', rule: 'alertAlert警告', url: 'components/alert' },
  { title: 'Loading 加载', rule: 'loadingLoading加载', url: 'components/loading' },
  { title: 'Message 消息提示', rule: 'messageMessage消息提示', url: 'components/message' },
  { title: 'Notification 通知', rule: 'notificationNotification通知', url: 'components/notification' },
  { title: 'Skeleton 骨架屏', rule: 'skeletonSkeleton骨架屏', url: 'components/skeleton' },
  { title: 'Loading Bar 加载条', rule: 'loading-barLoadingBar加载条', url: 'components/loading-bar' },
  { title: 'BackTop 返回顶部', rule: 'back-topBackTop返回顶部', url: 'components/back-top' },
  { title: 'Dialog 对话框', rule: 'dialogDialog对话框', url: 'components/dialog' },
  { title: 'Drawer 抽屉', rule: 'drawerDrawer抽屉', url: 'components/drawer' },
  { title: 'Tooltip 消息提示', rule: 'tooltipTooltip消息提示', url: 'components/tooltip' },
  { title: 'Popup 弹出窗口', rule: 'popupPopup弹出窗口', url: 'components/popup' },
  { title: 'Swap 切换', rule: 'swapSwap 切换', url: 'components/swap' },
  { title: 'Toolbar 工具栏', rule: 'toolbarToolbar工具栏', url: 'components/toolbar' },
