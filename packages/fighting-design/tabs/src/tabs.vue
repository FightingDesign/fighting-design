<script lang="ts" setup name="FTabs">
  ...
  import { getCurrentInstance, onMounted, ref, VNode, ComponentInternalInstance, provide } from 'vue'
  ...
  function getNavItem () {
    ...
    navs.value = panes.map((e, i) => ({
      name: e.props.name || i, // name如果没填，用下标代替
...
<template>
  <div class="f-tabs">
    <tabs-nav :navs="navs" @setCurrentName="setCurrentName"/>
